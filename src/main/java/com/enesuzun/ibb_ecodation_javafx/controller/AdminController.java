...
public class AdminController {
    ...
    private void refreshTable() {
        ...
        /// ObservableList bir işlem olur sonra olacak kısımdır
    ...
    private void logout() {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/enesuzun/ibb_ecodation_javafx/view/login.fxml"));
